package com.messenger.application.ui.custom.media;
...
import com.messenger.application.ui.custom.media.holders.IncomingVoiceMessageViewHolder;
import com.messenger.application.ui.custom.media.holders.OutcomingVoiceMessageViewHolder;
...
public class CustomMediaMessagesActivity extends DemoMessagesActivity
        ...
        MessageHolders.ContentChecker<DialogMessage>,
    ...
    @Override
    public boolean hasContentFor(DialogMessage message, byte type) {
        switch (type) {
